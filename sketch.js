...
function preload() {
  ...
  fogueteImg = loadAnimation("img/foguete.png");//imagens com animação
...
function draw() {
  ...
  textSize(25)//tamanho de letra 
  fill("white")// cor 
  text("Vidas: " + life, 60,100)//texto sobre vida obs...Tamanho 
  ...
  if (gameState == "play") {
    fundo.velocityY = 5;//velocidade em vertical (Y)
